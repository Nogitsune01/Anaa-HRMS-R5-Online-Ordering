      ...
      <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto my-4 sm:my-10">
        <div class="sm:w-11/12 lg:w-3/4 mx-auto">
            ...
            <div class="mt-6">
              <div class="border border-gray-200 p-4 rounded-lg space-y-4 dark:border-gray-700">
                ...
                @php  
                        $total = 0;
                @endphp
                <form action="{{ url('orders/update-quantity/'.$user->id) }}" method="POST" id="cartForm">
                @csrf
          ...
          <div class="mt-6 flex justify-end gap-x-3">
            ...
            <form action="{{ url('http://192.168.101.75:8000/checkout-card/'.$user->email) }}" method="GET">
                  ...
                  <div class="relative flex flex-col bg-white border shadow-sm rounded-xl overflow-hidden dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="p-4 sm:p-10 overflow-y-auto">
                      ...
                      <div class="grid grid-cols-2 gap-4">
                        ...
                        <a href="{{ url('http://192.168.101.75:8000/cash-on-receipt/'.$user->email) }}" class="btn btn-outline-primary p-6">
